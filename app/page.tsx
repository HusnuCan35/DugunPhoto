...
export default function HomePage() {
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Progress tracking için state'ler (opsiyonel olarak eklenebilir)
    ...
    // Tüm fotoğrafları photos state'ine ekle
    ...
    for (let i = 0; i < validFiles.length; i++) {
      ...
      try {
        ...
        if (error) {
          ...
          console.log(`Supabase'e başarıyla yüklendi (${file.name}):`, data);
